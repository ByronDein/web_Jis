...
<header class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-blue-600 text-sm py-3 sm:py-0">
  <nav class="relative max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 mt-2 mb-2" aria-label="Global">
    <div class="flex items-center justify-between">
      <router-link class="flex-none text-xl font-semibold text-white" to="/" aria-label="Brand"><img src="../assets/logo.png" class="w-20" alt=""></router-link>
      <div class="sm:hidden">
    ...
    <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
      <div class="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:ps-7">
        <router-link class="font-medium text-white sm:py-6" to="/home"  aria-current="page">Inicio</router-link>
        <router-link class="font-medium text-white/[.8] hover:text-white sm:py-6" to="/about_us" >Nosotros</router-link>
        ...
        <a class="flex items-center gap-x-2 font-medium text-white/[.8] hover:text-white sm:border-s sm:border-white/[.3] sm:my-6 sm:ps-6" href="https://jisparking.com/login" target="_blank" >
